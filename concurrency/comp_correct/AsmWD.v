...
Proof.
  ...
  }
  {
    ...
    pose proof (loadv_fp_emp_effects (AST.chunk_of_type ty)
                  (Values.Val.offset_ptr (rs (Asm.IR Asm.RSP))
                     (Integers.Ptrofs.repr (Stacklayout.fe_ofs_arg + 4 * ofs)))) as Hload1.
    pose proof (loadv_fp_emp_effects (AST.chunk_of_type ty0)
                  (Values.Val.offset_ptr (rs (Asm.IR Asm.RSP))
                     (Integers.Ptrofs.repr (Stacklayout.fe_ofs_arg + 4 * ofs0)))) as Hload2.
    apply Locs.locs_eq in Hload1. apply Locs.locs_eq in Hload2.
    rewrite Hload1,Hload2. apply Locs.union_refl.
  }
  {
