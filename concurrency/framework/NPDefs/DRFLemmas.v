...
(*  Definition invpc (pc:@ProgConfig GE):Prop:=ThreadPool.inv pc.(thread_pool).
  ...
  Lemma npnsw_or_sw_star_not_cur_valid_tid:
      ...
      destruct H5.
      {
        ...
        }
        {
          ...
          destruct H15 as [|[|[]]].
          {
            ...
            apply atomblockstarN_cur_valid_tid in H15 as ?;auto;try lia.
          ...
          }
          {
            ...
            }
            {
              ...
              {
                destruct H20 as (?&?&?&?&?).
                apply atomblockstarN_cur_valid_tid in H20 as ?;auto;try lia.
                assert(type_glob_step glob_sw x sw FP.emp ({-|x,cur_tid x5})).
    ...
    Proof.
      ...
      eapply noevt_stepN_Si_to_atomblockstarN in H;eauto;[|lia].
      Hsimpl. Esimpl;eauto.
    ...
    Proof.
      ...
      }
      {
        ...
        assert(S (S i-1) = S (S i) -1). lia. rewrite <- H11;eauto.
        Esimpl;eauto.
        rewrite H6;auto.
    ...
    Proof.
      ...
      }
      {
        ...
        apply noevt_stepN_Si_to_atomblockstarN in H;auto;[|lia].
    ...
    Proof.
      ...
      }
      {
        ...
        eapply atomblockstarN_np in H5;[|lia|erewrite swstar_l1;eauto].
        Hsimpl.
    ...
    Proof.
      ...
      induction i;intros.
      {
        ...
        {
          apply noevt_stepN_np in H4;auto;[|lia].
          Hsimpl.
          ...
          }
          {
            ...
            {
              apply atomblockstarN_np in H5;[|lia|erewrite swstar_l1;eauto].
              Hsimpl.
              destruct H7.
              {
                Hsimpl.
      ...
      }
      {
        ...
        destruct H8.
        {
          ...
          }
          {
            ...
            apply atomblockstarN_np in H8;auto;[|lia].
            Hsimpl.
            destruct H10.
            {
              Hsimpl.
