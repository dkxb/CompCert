...
*)
  ...
  Proof.
    ...
    exists 0,FP.emp,pc. split. constructor. split. lia.
    exists s2. split;auto.
    exists fp2. split;auto.
    simpl. assert(i-0=i). lia.
    rewrite H3;auto.
    ...
    }
    {
      ...
      }
      {
        ...
        exists x1;split.
        {
          ...
          assert(S(n-x-1) = n-x). lia.
          rewrite H22 in H15.
          assert(n=x+(n-x)). lia. rewrite H23.
          rewrite<- fpunion.
  ...
  Proof.
    ...
    {
      apply atomblockstarN_np in H0 as ?;auto;[|lia].
      Hsimpl.
  ...
  Proof.
    ...
    }
    {
      ...
      apply noevt_stepN_Si_to_atomblockstarN in H0;auto;[|lia].
      Hsimpl.
      destruct H4 as [|[|[|]]].
      {
        Hsimpl.
  ...
  Proof.
    ...
    }
    {
      ...
      apply atomblockstarN_np in H1;auto;[|lia].
  ...
  Proof.
    ...
    apply npnsw_or_sw_stepN_inv1 in H;[|lia].
    Hsimpl.
    assert(S i - 1 = i). lia.
  ...
  (*
   ...
   Proof.
     ...
     {
       apply npnsw_or_sw_stepN_inv1 in H0;[|lia].
       Hsimpl;subst. assert(S i-1=i). lia. rewrite H6 in *;clear H6.
       assert(drf_pc_glob x0).
...
*)
  ...
  Proof.
    ...
    {
      eapply noevt_stepN_Si_to_atomblockstarN in H3;eauto;[|lia].
      Hsimpl.
      destruct H5;Hsimpl.
    ...
    {
      apply noevt_stepN_Si_to_atomblockstarN2 in H3;auto;[|lia].
      Hsimpl. 
      destruct H5;Hsimpl.
      Esimpl;eauto;left;Esimpl;eauto.
  ...
  (*
    ...
    
    {
      ...
      }
      {
        ...
        eapply atomblockstarN_np in H7;eauto;[|lia].
        Hsimpl. destruct H17.
        {
          Hsimpl.
...
Section diverge_proof.
  ...
  Proof.
    ...
    apply atomblockstarN_cur_valid_tid in H6 as ?;try eassumption;[|lia].
  ...
  Proof.
    ...
    apply npnsw_or_sw_stepN_inv1 in H2;[|lia].
    Hsimpl.
    assert(S i - 1 = i). lia.
...
Definition no_rep (l:list tid):Prop:=
  ...
  Proof.
    ...
    assert(S i < length(t::l)). simpl. lia.
    assert(S j < length(t::l)). simpl;lia.
...
Qed.
  ...
  Proof.
    ...
    }
    {
      ...
      apply atomblockstarN_np in H4;auto;[|lia].
      Hsimpl.
      destruct H6;Hsimpl.
