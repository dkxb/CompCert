...
*)
  ...
  Proof.
    ...
    }
    {
      ...
      + rewrite <- pc_cur_tid with(pc:=pc) in H0.
        ...
        destruct H8.
        - left. exists 0;Esimpl;eauto. constructor. lia. apply FP.subset_emp.
      ...
      + apply FP.smile_conflict_compat in H5.
        ...
        - apply npnsw_step_tid_preservation in H7 as ?.
          ...
          left. Esimpl;try apply H18;eauto. lia.
  ...
  Proof.
    ...
    exists 0;Esimpl;eauto. constructor. lia.
  ...
  Proof.
    ...
    apply classic. destruct H4.
    {
      ...
      destruct H7.
      left. exists 0;Esimpl;eauto. constructor. lia. apply FP.subset_emp.
      Hsimpl. right. exists 1;Esimpl;eauto. rewrite <- FP.fp_union_emp with(fp:=x); econstructor 2;[eauto|constructor]. lia.
    }
    {
      rewrite <- pc_cur_tid with(pc:=pc) in H0.
      apply FP.smile_conflict_compat in H4.
  ...
  Proof.
    ...
    }
    {
      ...
      }
      {
        ...
        lia.
        destruct H16;Hsimpl.
        Esimpl;eauto. left;split;eauto. lia.
        Esimpl;eauto. right;split;eauto. lia.
      }
    }
  Qed.
