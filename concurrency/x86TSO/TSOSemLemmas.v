...
Section BUFFER.
    ...
    simpl;unfold alloc;eauto.
    {
      destruct bi1.
      {
        ...
        }
        {
          ...
          destruct zle,zlt;try lia;simpl;auto.
          constructor.
        }
      }
      {
    ...
    }
    {
      destruct bi1.
      {
        ...
        }
        {
          ...
          Locs.unfolds.
          assert(z<=ofs<z+size_chunk m). lia.
  ...
  Proof.
    ...
    }
    {
      ...
      }
      {
        ...
        exists b ofs. ex_match2. destruct zle,zlt;auto;try lia.
        ...
        intro.
        specialize (H0 b ofs).
        ex_match2. destruct H4,zle,zlt,zle,zlt;try lia;simpl in *;exploit H0;auto.
      }
    }
    {
      simpl in H,H1|- *.
      ...
      }
      {
        ...
        specialize (H0 b ofs).
        ex_match2. destruct zle,zlt,zle,zlt;try lia;exploit H0;eauto.
      }
    }
    {
      simpl in H1|-*.
      ...
      }
      {
        ...
        ex_match2. constructor.
        {
          ...
          rewrite <-add_minus_eq.
          destruct zle,zlt,zle,zlt;try lia;auto.
          ...
          destruct zle,zlt,zle,zlt;try lia;exploit H0;eauto.
        }
        {
          eapply H3;eauto.
        }
    ...
    }
    {
      ...
      unfold free in *;ex_match2.
      {
        ...
        }
        {
          ...
          ex_match2.
          destruct zle,zlt;try lia;inv Hx2.

          contradict H0.
          split;auto.
          unfold FMemOpFP.free_fp;apply FP.conflict_ff;simpl;Locs.unfolds.
          exists b0 ofs. apply andb_true_iff;split;auto;unfold FMemOpFP.range_locset;ex_match2;rewrite <- add_minus_eq;destruct zle,zlt;try lia;auto.
        }
      }
      {
    ...
    }
    {
      ...
      Locs.unfolds. exists b0 ofs. apply andb_true_iff;split. unfold FMemOpFP.range_locset. ex_match2. clear Hx0. destruct zle,zlt;try lia;auto. ex_match2.

      unfold FMemOpFP.range_locset. intro.
      Locs.unfolds. specialize (H0 b0 ofs). ex_match2.
      rewrite <- add_minus_eq in H0.
      assert(zle z0 ofs && zlt ofs z1 = true).
      apply H0. clear H0 Hx0. destruct zle,zlt;auto;lia.
      congruence.
    }
    {
      simpl in *. Hsimpl.
      ...
      ex_match2.
      {
        ...
        clear Hx2. destruct zle,zlt;auto;try lia.
      }
      {
        clear Hx Hx0 H1.
        contradict n.
  ...
  Proof.
    ...
    }
    {
      ...
      rewrite !PMap.gss in *.
      ex_match2.
      destruct zle,zlt,zle,zlt;auto with bool; lia.
    }
    {
      ...
      destruct zle,zlt;auto with bool;try lia.
    }
    {
      destruct v0 as [? _],v1 as [? _].
      destruct H as [? R].
    ...
    intros.
    {
      ...
      - ex_match2.
        + subst. rewrite PMap.gss in H. inv H.
          ...
          {
            inv H1;simpl. eexists;split;eauto. lia.
            eapply fid_valid in H;eauto.
            destruct H as [?[]]. exists x;split;eauto. lia.
          }
          {
