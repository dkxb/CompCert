...
Proof.
  ...
  { (* store *)
    ...
    { constructor; unfold GMem.valid_block; simpl; repeat rewrite PMap.gss; simpl; inv H; try tauto.
      ...
      { repeat rewrite FMemory.Mem.setN_outside; auto; lia. }
    }
...
Proof.
  ...
  { (* free *)
    ...
    { constructor; simpl.
      ...
      { intros. rewrite PMap.gss. destruct zle, zlt; simpl; auto. lia. }
      { auto. }
    }
    { constructor; simpl.
  ...
  { (* store *)
    ...
    { constructor; simpl.
      { unfold GMem.valid_block. split; auto. }
      { intros. auto. }
      { rewrite PMap.gss. rewrite FMemory.Mem.setN_outside. auto. lia. }
    }
    { constructor; simpl.
      { unfold GMem.valid_block. split; auto. }
      { intros. auto. }
...
Proof.
  ...
  right;eauto. assert((i-0)%nat=i). lia.
  split;auto.
  congruence.
  lia.
  ...
  left;eauto. right;split;auto. lia.
Qed.
Lemma nth_error_nil:
  forall A i,
