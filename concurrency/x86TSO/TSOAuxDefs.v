...
Proof.
  ...
  constructor.
  {
    ...
    exploit r0. instantiate(1:=ofs) ;lia.
    intro;apply Memperm_validblock in H.
    exploit r. instantiate(1:=ofs) ;lia.
  ...
  }
  {
    ...
    destruct Hx1. destruct zle;try lia;try discriminate.
    destruct zlt;try discriminate;try lia.
  }
Qed.
    ...
    rename H2 into R. rename H into H2. rename R into H3.
    {
      ...
      }
      {
        unfold range_locset in Heqb1. ex_match;subst.
        {
          ...
          erewrite !Mem.setN_outside;eauto;try (left;lia).
          apply H2;auto.
...
Proof.
  ...
  }
  {
    ...
    ex_match2; subst.
    destruct (zle z ofs); destruct (zlt ofs (z + size_chunk chunk));
      try discriminate;try contradiction; try lia; simpls.
    auto.
  }
Qed.
...
Proof.
  ...
  }
  {
    ...
    destruct (zle z ofs); destruct (zlt ofs z0); simpls;
      try discriminate; try contradiction; try lia; eauto.
  }
Qed.
...
| exec_initialize_call: 
  ...
  Proof.
    ...
    eapply R;eauto;apply range_locset_belongsto;split;auto;split;lia.
  Qed.
